# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-01-19 00:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[(accounts.choices.Gender(b'other'), 'Other'), (accounts.choices.Gender(b'female'), 'Female'), (accounts.choices.Gender(b'male'), 'Male')], default=b'other', help_text='User Gender', max_length=8, verbose_name='Gender')),
